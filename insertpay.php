...
<form  method='POST' action='insertmoney.php' onsubmit='returnn formValidation()' enctype="multipart/form-data">
...
<tr><td><font color=red> * </font><font color=black>last_name :</td><td><input type="text" name="lname" value="" size='20%' id="txt_2" placeholder='Lname' pattern="\D{2,10}" required x-moz-errormessage="Please Enter Letter Only Above 2 characters " title="Please Enter Letter Only Above 2 characters" ></input></td></tr><br>
<tr><td><font color=red> * </font><font color=black>branch :</td><td><input type="text" name="branch" value="" size='20%' id="txt_2" placeholder='Lname' pattern="\D{2,10}" required x-moz-errormessage="Please Enter Letter Only Above 2 characters " title="Please Enter Letter Only Above 2 characters" ></input></td></tr><br>
<tr><td><font color=red> * </font> <font color=black>account number :</font></td><td><input type="text"  required x-moz-errormessage="Please Enter NUMBER Only " title="Please Enter Letter Only Above 2 characters "  name="accno"  value="" size='20%' id="txt_fname" placeholder='accno'></input></td></tr>
...
$sql="INSERT INTO bank(first_name,last_name,branch,accno,amountofbirr,date)
VALUES('$_POST[fname]','$_POST[lname]','$_POST[branch]','$_POST[accno]','$_POST[amountofbirr]',curdate())";
...
echo "<h2>YOU Have Succesfully store  your money !</h2>";
mysql_close($p);
?>
</form>
