...
$sql="INSERT INTO employee(EID,fname,lname,address,phone,housno,date)
VALUES('$_POST[CID]','$_POST[fname]','$_POST[lname]','$_POST[address]','$_POST[phone]','$_POST[houseno]',curdate())";
...
die('Error: ' . mysql_error());
	...
	echo "<h1>you have succesfully registored emplyee</h1>";
