...
?></font>
	 ...
	 <form  method='POST' action='elinsert.php' onsubmit='returnn formValidation()' enctype="multipart/form-data" style="width: 493px">
	 ...
	 <tr><td class="auto-style3" style="height: 41px;">amount of bill:</td>
		 <td class="auto-style3" style="height: 41px"> <input type="text" name="amountofbill" required pattern="\d{1,10}"></td></tr>
  <br><br>
  <tr>
...
<div 
	...
	The mission of Arbaminch town centralized billing system is:-<br>
			 Giving plan based service to society according to our country development and transformation plan.<br>
