...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2016 at 03:30 PM
...
('kasish', 'alemayehu', 'dashin', 111, 30, '<br /><b>Notice</b>:  Undefined va'),
('kasish', 'alem', 'cbe', 1440, 30, '<br /><b>Notice</b>:  Undefined va'),
('kasish', 'alemayehu', 'dashin', 1570, 50, '<br /><b>Notice</b>:  Undefined va'),
('temesgen', 'tameire', 'cbe', 1571, 10, '<br /><b>Notice</b>:  Undefined va'),
('tg', 'abre', 'cbe', 3456, 111, '<br /><b>Notice</b>:  Undefined va');
...
--
ALTER TABLE `bank`
  MODIFY `secretcode` int(35) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3457;
--
