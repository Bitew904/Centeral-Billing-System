...
--
-- Host: 127.0.0.1
-- Generation Time: May 24, 2016 at 03:23 PM
...
('temu', 'tom', 'cbe', 1234, 300, '<br /><b>Notice</b>:');
...
('admin/123/00', 'YWRtaW4=', 'Administrator', NULL, NULL, 0),
('admin/123/01', '', 'Administrator', NULL, NULL, 0),
('bank/111/08', 'tom', 'bank', NULL, NULL, 1),
('BNN/099/07', 'VEVN', 'customer', NULL, NULL, 0),
('emp/000/00', 'ZW1wbG95ZWU=', 'employee', NULL, NULL, 0),
('emp/111/05', 'temu', 'employee', NULL, NULL, 1),
('emp/123/01', 'MTIzNDU=', 'employee', NULL, NULL, 0),
('mek/123/45', 'bWVrdQ==', 'customer', NULL, NULL, 0),
('meku/123/09', 'bWVrdQ==', 'customer', NULL, NULL, 0),
('rmnt/456/90', 'dGVt', 'customer', NULL, NULL, 0),
('tem/123/08', 'tem12', 'Administrator', NULL, NULL, 1),
('temu/123/05', 'dG9t', 'customer', NULL, NULL, 0),
...
--
ALTER TABLE `useraccount`
  ADD CONSTRAINT `useraccount_ibfk_1`,
  ADD CONSTRAINT `useraccount_ibfk_2`,
