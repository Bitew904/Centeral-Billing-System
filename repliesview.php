...
<div id="header" style="width: 1197px; height: 149px;">
	...
	<div id="menubar">
      <ul id="menu">
	   ...
	   <li><a href="replies.php"><font color="white">view replies</font></a></li>
...
<hr><hr>
	  ...
	  <!--close sidebar_container-->	
        ...
        <div class="auto-style2" style="height: 577px; width: 670px">
		  <h1 class="style9"><b>Enter Your Email To Search Replies  : </h1>
<?php
$name=$_POST['email'];
...
$sql=mysql_query("select *  from replies where email ='$name'");
if(mysql_num_rows($sql) < 1) {
            echo " ";
			echo "<script>alert('your email not found ,please enter your email correctly!.');window.location.href='replies.php';</script>";
		   exit();
        }
...
while($row = mysql_fetch_array($sql))
  {
	  ?> 
			...
			<form  method='POST' action='repliesview.php' onsubmit='return validateForm()' enctype="multipart/form-data">	  
 ...
 height:386px;" class="auto-style1">
 				   ...
 				   <br>
  E-mail:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}" required x-moz-errormessage="Please Enter email in valid format" >
  ...
  <input type="submit" name="submit" value="search"></td></tr><br />
				   ...
				   <br />
&nbsp;<table>
		 <tr><td>E-mail:</td><td><input type="text" name="email" value="<?php echo $row['email'];?>" ></input></td></tr>
		 <tr><td>Replies:</td><td><input type="text" name="replies" value="<?php echo $row['replies'];?>" ></input></td></tr>
