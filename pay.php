...
<hr><hr></body>
	  ...
	  <div id="content1" style="width: 792px">
		...
		<center>
		<div style="width:820px; height:637px; position:relative; border:4px solid rgba(0,0,0,0); 
...
$sql=mysql_query("select *  from customer where CID ='$name'");
if(mysql_num_rows($sql) < 1) {
            echo " ";
			echo "<script>alert('customer id not found ,please enter Customer id correctly!.');window.location.href='billsearch.php';</script>";
		   exit();
        }
...
<tr><td class="auto-style4" style="width: 179px"><font color=red> * </font> <font color=black>fname :</font></td>
...
<tr><td class="auto-style4" style="width: 179px"><font color=red> * </font><font color=black>lname:</td>
	<td style="width: 358px">
...
<tr><td class="auto-style4" style="width: 179px"><font color=red> * </font> <font color=black>address :</font></td>
	<td style="width: 358px">
...
<tr><td style="width: 179px" class="auto-style4"><font color="black">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; amount of bill 
	:</font></td>
	<td style="width: 358px" class="auto-style2">
 ...
 <tr><td class="auto-style4" style="width: 179px"><font color=red> * </font> <font color=black>Rate:</font></td>
	 <td style="width: 358px">
 ...
 <tr><td class="auto-style4" style="width: 179px"><font color=red> * </font> <font color=black>amountofbirr :</font></td>
	 <td style="width: 358px">
...
<tr><td class="auto-style4" style="width: 179px"><font color=red> * </font> <font color=black>phone_No :</font></td>
	<td style="width: 358px">
...
<tr><td class="auto-style4" style="width: 179px"><font color=red> * </font> <font color=black>account number:</font></td>
	<td style="width: 358px">
	<input type="text" pattern="[0-9]+"  required x-moz-errormessage="Please Enter your phone No" title="Please Enter your phone No "  name="accno"  value="" size='20%' id="txt_phone_no" placeholder='accountno' style="width: 235px"></input></td></tr>
<tr><td class="auto-style4" style="width: 179px"><font color=red> * </font><font color=black>servicetype:</td>
	<td style="width: 358px">
...
<option>telecome bill</option>
  ...
  <tr><td class="auto-style4" style="width: 179px"><font color=red> * payment 
	 moonth</font></td>
	<td style="width: 358px">
&nbsp;<select name="mounth" required x-moz-errormessage="Please Enter mounth you need  " title="Please Enter mounth you need" style="width: 181px" >
...
<option>may</option>
 ...
 <?php }?>
<tr><td style="width: 179px" class="auto-style4"><input type="button" name="Sumbit" style="background-color:#808000" value="compute" class="button_example" onclick="javascript:calculatebill()"/></td>
	<td style="width: 358px">
