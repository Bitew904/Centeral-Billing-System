...
<div id="site_content">		
	  ...
	  <div class="sidebar_container" style="width: 254px">       
		<div class="sidebar">
...
<hr><hr></body>
		...
		<font size="5"color="green"><b></b></font>
			...
			<tr><td></td><td><img width="215" height="100"src="Img/wt.jpg">						</tr>
	  ...
	  <div id="content1">
		...
		<center>
		<div style="width:589px; height:650px; position:relative; border:4px solid rgba(0,0,0,0); 
		-webkit-border-radius:5px; -moz-border-radius:5px; border-radius:25px; -webkit-box-shadow:0 0 18px rgba(0,0,0,0.4); 
		-moz-box-shadow:0 0 18px rgba(0,0,0,0.4); box-shadow:0 0 18px rgba(0,0,0,0.4); left: -69px; top: 0px; margin-left: auto; margin-right: auto; margin-bottom: 0;">
