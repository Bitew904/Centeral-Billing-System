...
<hr><hr>
	...
	<form  method='POST' action='cntct1.php' onsubmit='return validateForm()' enctype="multipart/form-data">	  
 ...
 height:386px;" class="auto-style1">
	 ...
	 <br />
	 <br />
 &nbsp;Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="name" pattern="\D{2,10}" required x-moz-errormessage="Please Enter your fname" >
  <br><br>
