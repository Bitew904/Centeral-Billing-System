...
<tr><td style="width: 591px" class="auto-style2"><font color=black>
	Customer ID:
	<input type="text" name="search" value="" size='20%' id="txt_l" placeholder='ID' pattern="\d{2,10}" required x-moz-errormessage="Please Enter your fname " title="Please Enter your name code" style="width: 143px" >
	</input>&nbsp;&nbsp;&nbsp; </td>
...
<input style="background-color:#808000; height: 47px; width: 87px;"type='submit' class="auto-style4" value="Search" name='submitMain' Onclick="return check(this.form);"/></h6>
	...
	<tr><td>
	<img width="730" height="392" src="Img/mn.png"/>
	</td></tr>
</form>
</center></div>
		 </div>
